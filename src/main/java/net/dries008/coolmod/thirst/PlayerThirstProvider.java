package net.dries008.coolmod.thirst;
...
public class PlayerThirstProvider implements ICapabilityProvider, INBTSerializable<CompoundTag> {
    ...
    private final LazyOptional<PlayerThirst> optional = LazyOptional.of(this::creatPlayerThirst);

    private PlayerThirst creatPlayerThirst() {
        if(this.thirst == null){
    ...
    public CompoundTag serializeNBT() {
        ...
        creatPlayerThirst().saveNBTData(nbt);
        return nbt;
    }

    @Override
    public void deserializeNBT(CompoundTag nbt) {
        creatPlayerThirst().loadNBTData(nbt);
    }
}
